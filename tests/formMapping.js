...
module.exports = {
    ...
    StatementfromPatient: {
        ...
        fields: {
            ...
            "Treating Doctor Visiting Dates" : {
                inputdate : "//*[@class='col-lg-6 align-top-grid align-top form-group']//div[@class='row'][2]//div//div//input[contains(@class,'vdatetime-input')]",
                addDiffdate : "//*[@class='col-lg-6 align-top-grid align-top form-group']//div[@class='row'][2]//div[@class='col-sm-3']//span//i"
            },
    ...
    HospitalDetails: {
        ...
        fields: {
            ...
            "Qualification" : [
                '//*[@class="row align-top"]//span[21]//div//div[2]//input',
                '//*[@class="row align-top"]//span[23]//div//div[2]//input'

            ],
            "Registration number": '//*[@class="row align-top"]//span[22]//div//div[2]//input',
            "Name of the Medical Certificate issuing Authority": '//*[@class="row align-top"]//span[24]//div//div[2]//input',
            ...
            "Audio / Video recording done": {
                ...
                option: '//*[@class="row align-top"]//span[28]//div//div[2]//select//option[1]',
            },
            "Indoor Case Paper observation": '//*[@class="row align-top"]//span[29]//div//div[2]//div//textarea'
        }
    },
    HospitalDocumentsPD: {
        openMain: LOCATORS.HospitalDetails.clickOpen,
    ...
    StatementfromTreatingDoctor: {
        ...
        fields: {
            ...
            "Registration number": '//*[@class="row align-top"]//span[4]//div//div[2]//input',
            "Complain History": '//*[@class="row align-top"]//span[6]//div//div[2]//textarea',
            "Total cost of treatment": '//*[@class="row align-top"]//span[7]//div//div[2]//input',
            "DOA" : '//*[@class="row align-top"]//span[8]//div//div[2]//input',
            "DOD" : '//*[@class="row align-top"]//span[9]//div//div[2]//input',
            "Consultation / Visiting hours - in this hospital": '//*[@class="row align-top"]//span[10]//div//div[2]//div/textarea',
            "Number of Visits done to the patient": '//*[@class="row align-top"]//span[11]//div//div[2]//input',
            "Verification of doctor attendence / Visit Register": '//*[@class="row align-top"]//span[12]//div//div[2]//div/textarea',
            "Diagnosis": '//*[@class="row align-top"]//span[13]//div//div[2]//textarea',
            "Reason for Admission": '//*[@class="row align-top"]//span[14]//div//div[2]//textarea',
            "Previous Medical / Surgical History / Treatment History": '//*[@class="row align-top"]//span[15]//div//div[2]//textarea',
            "Any special diet?": '//*[@class="row align-top"]//span[16]//div//div[2]//textarea',
            "Details of Statement issued by Treating Doctor Visit findings": '//*[@class="row align-top"]//span[17]//div//div[2]//div//textarea'
        }
    },
    ...
    PaymentReceiptsverifications: {
        ...
        fields: {
            ...
            "State": '//*[@class="row align-top"]//span[8]//div//div[2]//input',
            "Pincode": '//*[@class="row align-top"]//span[6]//div//div[2]//input',
    ...
    RadiologyCenter: {
        ...
        fields: {
            ...
            "Radiology manual register & Other findings – Visting findings": '//*[@class="row align-top"]//span[8]//div//div[2]//textarea',
    ...
    Trigger: {
        openMain: LOCATORS.Trigger.clickOpen,
        openSub: LOCATORS.Trigger.clickTrigger,
        fields: {
            "Effective or not effective": {
                dropdown: '//*[@class="table-responsive w-100 trigger-questionnaire-table"]//tbody//tr//td[3]//select',
                option: '//*[@class="table-responsive w-100 trigger-questionnaire-table"]//tbody//tr//td[3]//select//option[2]',
            },
            "Investigator Remarks": '//*[@class="table-responsive w-100 trigger-questionnaire-table"]//tbody//tr//td[4]//div//input'
        }
    }
}
