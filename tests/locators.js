const LOCATORS = {
    ...
    popup :'//*[@class="modal-content"]/div/div/div/div/h3[text()="Are you sure want to Discard the Changes ?"]', 
    // '//*[@class="modal-content"]/div/div',
    confirmYesBtn: '//*[@class="modal-content"]/div/div/div/div/ul/li[1]',
    //'//*[@class="modal-content"]//div//div//div//div[@class="modal-pop-padding"]//ul//li[1]//a',
