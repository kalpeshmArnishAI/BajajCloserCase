...
Scenario('Convert PDF, Validate JSON, and Open Browser', async () => {
  ...
  const pdfFilePath = 'InputExmaple7.pdf';
  ...
  I.wait(2);
  I.fillField(LOCATORS.searchbar.searchInput, "OC-26-1002-8403-00574952")
  I.wait(10);
